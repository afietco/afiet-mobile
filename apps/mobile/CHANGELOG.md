...
- ✨ Hedeflerim geldi: Vücudum'daki "Yakında" kartı artık gerçek bir ekran. Günün ölçüsünü el diliyle söylüyor ("3-4 avuç içi protein kaynağı", "3 yumruk sebze"); gram ve kalori duruyor ama "Sayılarla" başlığının altında, katlanmış hâlde. Ondalık yok, aralık var: hesabın hata payı varken "3,5 avuç" demek sahte bir kesinlik olurdu.
- ✨ Ölçüler artık senin vücudunla hesaplanıyor. Mezura ölçünü girdiysen yağsız kütlen üzerinden (Katch-McArdle), girmediysen eskisi gibi. Protein kaloriden değil yağsız kütleden ölçekleniyor, yağın bir tabanı var ve karbonhidrat kalandan geliyor. Hareket düzeyi tek bir çarpan değil, aralık.
- ✨ Bir yön seçebiliyorsun: "Daha hafif hissetmek istiyorum", "Kilom değişmeden daha iyi hissetmek istiyorum", "Olduğum yerde iyiyim", "Daha güçlü hissetmek istiyorum", "Önce bir düzen kurayım". Seçim gelecek pazartesi geçerli oluyor ve ekran bunu açıkça yazıyor; hedefler gün içinde kaymıyor. Yön seçmezsen sessiz bir varsayılan çalışıyor, ekran ilk günden dolu görünüyor.
- ✨ "Afi seni %60 tanıyor" göstergesi, eksik veriyi ceza dili kurmadan davet ediyor. Her eksik satır bir kapı; hiçbiri kırmızı bir işaret değil. Beta'da var olmayan hiçbir madde listede yok, yani %100 gerçekten ulaşılabilir.
- ✨ İlk adımların bittiğinde Afi bir kez yön öneriyor: "Şu an dengede tutuyorum. İstersen bana bir yön söyle, ölçülerini ona göre kurayım." Kurulumda sorulmuyor, kaçırırsan Hedeflerim'de sakin bir satır olarak duruyor.
...
- 🔧 Vücudum'daki ayrı "veri" kartı kalktı; o sayılar Hedeflerim'in "Sayılarla" katmanına taşındı. /veri bağlantısı çalışmaya devam ediyor (bildirimler oraya derin bağlantı kurabiliyor).
