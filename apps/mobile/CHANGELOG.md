...
- ✨ Günün ölçüsü geldi ve Beslenme'de makro kartının yerini aldı: artık el diliyle konuşuyor ("4 avuç içi protein kaynağı", "5-6 yumruk sebze"). Gram ve kalori kaybolmadı, aynı kartın "Sayılarla" tarafında duruyor; başlıktaki ikili düğmeyle geçiyorsun ve tercihin hatırlanıyor. Ondalık yok, aralık var: hesabın hata payı varken "3,5 avuç" demek sahte bir kesinlik olurdu.
- ✨ Ölçüler artık senin vücudunla hesaplanıyor. Mezura ölçünü girdiysen yağsız kütlen üzerinden (Katch-McArdle), girmediysen eskisi gibi. Protein kaloriden değil yağsız kütleden ölçekleniyor, yağın bir tabanı var, karbonhidrat kalandan geliyor ve hareket düzeyi tek bir çarpan değil aralık. İki görünüm de aynı motoru okuyor, yani aynı gün için iki ayrı hedef görmüyorsun; protein sayısı eskisinden düşük çıkabilir.
- ✨ Afi bir kez yön soruyor: "Ölçülerini neye göre kurayım?" Beş yanıt var ("Daha hafif hissetmek istiyorum", "Kilom değişmeden daha iyi hissetmek istiyorum", "Olduğum yerde iyiyim", "Daha güçlü hissetmek istiyorum", "Önce bir düzen kurayım") ve dokunduğun an seçilmiş oluyor. Kurulumda sorulmuyor, ilk adımların bittiğinde geliyor. Seçim gelecek pazartesi geçerli oluyor ve Afi bunu açıkça söylüyor; hedefler gün içinde kaymıyor. Sonradan değiştirmek için Vücudum'da "Yönüm" satırı var.
- ✨ Vücudum'da "Afi seni %60 tanıyor" göstergesi, eksik veriyi ceza dili kurmadan davet ediyor. Her eksik satır bir kapı; hiçbiri kırmızı bir işaret değil. Beta'da var olmayan hiçbir madde listede yok, yani %100 gerçekten ulaşılabilir.
...
- 🔧 Vücudum'daki ayrı "veri" kartı kalktı; o sayılar aynı sayfadaki katlanmış "Sayılarla" bölümüne taşındı. /veri bağlantısı çalışmaya devam ediyor (bildirimler oraya derin bağlantı kurabiliyor).
