...
- 🔧 Lig ekranı artık kendini anlatıyor. Sofranın Afi ile konuşma hakkını kaç mesaja çevirdiği (ve bir üst sofrada kaça çıkacağı) ekranın en görünür yerinde duruyor; ligin ne işe yaradığı sorusunun cevabı buydu ve dipnottaydı. Yükselme bölgesine kaç puan kaldığı yazıyor. Ayın puanının nereden geldiği kaynak kaynak dökülüyor. Ve en altta katlanır bir bölümde neyin kaç puan getirdiği tam tabloyla var: afiyet günü 20, afiyet haftası 60, öğün kaydı 2, su hedefi 5, ölçüm 10, karşılıklı selam 1. Her satır tavanını da söylüyor, çünkü tavanı söylemeyen bir tablo yanlış vaat verir: elli öğün kaydeden biri yüz puan beklerdi, altı alır.
