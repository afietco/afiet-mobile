...
- 🐛 Sohbette mikrofona basınca uygulama kapanıyordu: iOS, mikrofon izni açıklaması olmayan bir uygulamayı izin isterken anında öldürüyor. Açıklama üç ayrı yerde birden düşmüştü (biri expo-audio eklentisinin kendi hatası, biri de galerinin "mikrofon kapalı" ayarı); artık uygulamanın içinde.
